...
const MANAGER_NAV = [
  ...
  { icon: Users, label: "Anggota & TVT", href: "/manager/members" }, // Fitur 2, 4
          ...
          {MANAGER_NAV.map((item) => {
            ...
            return (
              <Link key={item.href} href={item.href}>
                <div className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-medium text-sm ${isActive
