...
let STAFF_LIST: StaffEvaluation[] = [
  ...
  { id: "7", name: "Anindiffa Pandu P", jabatan: "TVT", type: 'PANITIA', scores: createZeroPanitiaScores(), rawScore: 0 },
  { id: "8", name: "Aulia Febrianto", jabatan: "TVT", type: 'PANITIA', scores: createZeroPanitiaScores(), rawScore: 0 },
  { id: "9", name: "Faiz Azilla Syaehon", jabatan: "TVT", type: 'PANITIA', scores: createZeroPanitiaScores(), rawScore: 0 },
