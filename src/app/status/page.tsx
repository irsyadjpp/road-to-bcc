        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          {state.success && state.data && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-xl">Status Verifikasi Pemain (TVT)</CardTitle>
                  <CardDescription>
                ...
                <CardFooter className="bg-secondary/10 p-4 text-xs text-muted-foreground">
                  *Keputusan Tim Verifikasi Teknis (TVT) bersifat mutlak. Jika status "Ditolak" atau "Naik Level", silakan hubungi panitia untuk revisi roster sebelum batas waktu.
                </CardFooter>
              </Card>
            </div>
          )}
